...
// Cache for loaded human model to avoid re-loading
let humanModelCache = null;

// Preloader component for human model
...
export const HumanBody = React.memo(({
  position = [0, 0, 0],
  rotation = [0, 0, 0],
  scale = 1,
  color = '#f0f0f0',
...
// Component to preload human model
